...
#define NPY_SIZEOF_COMPLEX_FLOAT        SIZEOF_FLOAT_COMPLEX
#define NPY_SIZEOF_COMPLEX_DOUBLE       SIZEOF_DOUBLE_COMPLEX
#define NPY_SIZEOF_COMPLEX_LONGDOUBLE   SIZEOF_LONG_DOUBLE_COMPLEX
