...
fftpack_cfftf(PyObject *NPY_UNUSED(self), PyObject *args)
{
    ...
    dptr = (double *)PyArray_BYTES(data);
    NPY_SIGINT_ON;
...
fftpack_cffti(PyObject *NPY_UNUSED(self), PyObject *args)
{
    ...
    NPY_SIGINT_ON;
    cffti(n, (double *)PyArray_BYTES(op));
    NPY_SIGINT_OFF;
...
fftpack_rffti(PyObject *NPY_UNUSED(self), PyObject *args)
{
  ...
  NPY_SIGINT_ON;
  rffti(n, (double *)PyArray_BYTES(op));
  NPY_SIGINT_OFF;
